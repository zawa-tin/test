...
template <typename T>
std::vector<std::vector<std::pair<int, T>>> readWeightedGraph(int n, int m, bool undirect = true, bool minus = true) {
...
template <typename T>
std::vector<std::vector<std::pair<int, T>>> readWeightedTree(int n, bool undirect = true) {
